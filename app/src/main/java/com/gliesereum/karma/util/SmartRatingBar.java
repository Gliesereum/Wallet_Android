...
public class SmartRatingBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mOrientation = typedArray.getInt(R.styleable.SmartRatingBar_customOrientation, LinearLayout.HORIZONTAL);
        ...
        if (mRatingDrawable == null && mRatingBackgroundDrawable == null) {
            mRatingDrawable = context.getResources().getDrawable(R.drawable.filled);
            mRatingBackgroundDrawable = context.getResources().getDrawable(R.drawable.empty);
        }
    }
